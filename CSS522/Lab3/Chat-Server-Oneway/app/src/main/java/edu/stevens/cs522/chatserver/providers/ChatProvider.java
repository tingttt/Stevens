...
public class ChatProvider extends ContentProvider {
    ...
    public static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            Log.d("DatabaseHelper", "Creating peer table with SQL: " + CREATE_PEER_TABLE);
            db.execSQL(CREATE_PEER_TABLE);
            Log.d("DatabaseHelper", "Peer table created successfully");

            Log.d("DatabaseHelper", "Creating message table with SQL: " + CREATE_MESSAGE_TABLE);
            db.execSQL(CREATE_MESSAGE_TABLE);
            Log.d("DatabaseHelper", "Message table created successfully");
        }
    ...
    public boolean onCreate() {
         ...
         */
        Log.d("ChatProvider", "Initializing database helper...");
        databaseHelper = new DatabaseHelper(getContext(), DATABASE_NAME, null, DATABASE_VERSION);
        Log.d("ChatProvider", "Database helper initialized.");
        return true;
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        Log.d("ChatProvider", "Messages table exists: " + tableExists(db, MESSAGES_TABLE));
        Log.d("ChatProvider", "Peers table exists: " + tableExists(db, PEERS_TABLE));
