...
// TODO initialize sendResultReceiver (for receiving notification of message sent)
        // TODO initialize sendResultReceiver (for receiving notification of message sent)
        sendResultReceiver = new PostMessageResultReceiver(new Handler(), this,this);
//        sendResultReceiver = new ResultReceiver(new Handler());
    ...
    public void onReceiveResult(int resultCode, Bundle data) {
        switch (resultCode) {
            case RESULT_OK:
                ...
                Toast.makeText(this, "Success: Message sent", Toast.LENGTH_LONG).show();
                break;
            default:
                // TODO show a failure toast message
                Toast.makeText(this, "Something went wrong: Could not send message", Toast.LENGTH_LONG).show();
                break;
        }
    }
    ...
    public void onServiceConnected(ComponentName name, IBinder binder) {
        ...
        ChatService.ChatBinder chatServe = (ChatService.ChatBinder) binder;
