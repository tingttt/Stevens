            ...
            try {
                ...
                mainLoop.post(() -> {
                    ...
                    if (registerResponse != null && !(registerResponse instanceof ErrorResponse)) {
                        ...
                        Notification.Builder successBuilder = createNotificationBuilder()
                                .setContentTitle(getString(R.string.register_notification_title))
                                .setContentText(getString(R.string.register_notification_message))
                                .setAutoCancel(true);
                        ...
                        // DO NOT DISPLAY A TOAST (It's unsafe.  Why?)
                        Notification.Builder failureBuilder = createNotificationBuilder()
                                .setContentTitle(getString(R.string.register_notification_title))
                                .setContentText(getString(R.string.register_failed_notification_message))
                                .setAutoCancel(true);

                        notificationManager.notify(notificationId, failureBuilder.build());
